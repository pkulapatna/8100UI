...
{
    /// <summary>
    /// Interaction logic for TwoLinesGraphicDropView.xaml
    /// </summary>
    public partial class TwoLinesGraphicDropView : UserControl
    {
        protected readonly Prism.Events.IEventAggregator _eventAggregator;

        public static TwoLinesGraphicDropView TwoLinesGraphicDropWindow;
        ...
        public TwoLinesGraphicDropView(IEventAggregator eventAggregator)
        {
            InitializeComponent();
            TwoLinesGraphicDropWindow = this;
            this._eventAggregator = eventAggregator;
            DataContext = new TwoLinesGraphicDropViewModel(_eventAggregator);
        ...
        private void BaleGraphic_sizeChanged(object sender, SizeChangedEventArgs e)
        {
           // double iScreenWidth = e.NewSize.Width;
            ...
            ScaleCoef = e.NewSize.Width * .36; //.36
            wdCoef = e.NewSize.Width * .54; //.54
            mkCoef = e.NewSize.Width * .70; //.775
            ...
            if (ClassCommon.BaleOrderLoToHiLnOne)
            {
                ...
                DefaultBaleOneScale = (int)ScaleCoef - 150;
                DefaultBaleTwoScale = (int)ScaleCoef - 160;
                DefaultBaleThreeScale = (int)ScaleCoef - 170;
                DefaultBaleFourScale = (int)ScaleCoef - 180;
                DefaultBaleFiveScale = (int)ScaleCoef - 190;
            }
            else
            {
                ...
                DefaultBaleOneScale = (int)ScaleCoef + 10;
                DefaultBaleTwoScale = (int)ScaleCoef + 20;
                DefaultBaleThreeScale = (int)ScaleCoef + 30;
                DefaultBaleFourScale = (int)ScaleCoef + 50;
                DefaultBaleFiveScale = (int)ScaleCoef + 60;
            }
            //Line Two
        ...
        public void ClearAllBalesLineOne()
        {
        ...
        internal void ClearBalesOnScaleConveyorLineOne()
        {
            baleOneLineOne.Visibility = Visibility.Hidden;
            baleTwoLineOne.Visibility = Visibility.Hidden;
            baleThreeLineOne.Visibility = Visibility.Hidden;
        ...
        internal void ClearAllBalePressConveyorLineOne()
        {
        ...
        public void ClearAllBalesLineTwo()
        {
