...
{
    public class TwoLineGraphicDropViewModel : TwoLineViewModelBase
    {
        ...
        public TwoLineGraphicDropViewModel(IEventAggregator eventAggregator)
        {
        ...
        private async Task BaleTimerEventsAsync()
        {
            ...
            await Task.Run(() =>
            {
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearBalesOnScaleConveyorLineOne(); }));

                    //put Bale on scale conveyor in order from BaleOnApproachConveyor list
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.PutBaleOnScaleConveyorLineOne(BaleOnApproachConveyor); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearBalesOnScaleConveyorLineOne(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBalePressConveyorLineOne(); }));

                    //put Bale on Press conveyor
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.PutBaleOnPressConveyorLineOne(BaleOnWeighConveyor); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBalePressConveyorLineOne(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBaleMrkConveyorLineOne(); }));

                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.PutBaleOnMarkerConveyorLineOne(BaleOnPressConveyor); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBaleMrkConveyorLineOne(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBalesOnScaleConveyorLineTwo(); }));

                    //put Bale on scale conveyor in order from BaleOnApproachConveyor list
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.PutBaleOnScaleConveyorLineTwo(BaleOnApproachConveyorLn2); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBalesOnScaleConveyorLineTwo(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBalePressConveyorLineTwo(); }));

                    //put Bale on Press conveyor
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.PutBaleOnPressConveyorLineTwo(BaleOnWeighConveyorLn2); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBalePressConveyorLineTwo(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBalesMrkConveyorLineTwo(); }));

                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.PutBaleOnMarkerConveyorLineTwo(BaleOnMarkerConveyorLineTwo); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicDropView.BaleGraphicTwoLinesWindow.ClearAllBalesMrkConveyorLineTwo(); }));
        ...
        private async Task UpdateShowBaleEvents()
        {
            try
            {
                await Task.Run(() =>
                {
                    ...
                    ShowDropOnShttleConveyor(_sqlHandler.GetBaleDatatable());
                });
            }
            catch (Exception ex)
            {
        ...
        private void ShowDropOnShttleConveyor(DataTable newData)
        {
        ...
        private void ShowDroponLayboyConveyor(int dropNum)
        {
            try
            {
                switch (dropNum)
            ...
            {
                ClsSerilog.LogMessage(ClsSerilog.Error, $"Error in ShowDroponLayboyConveyor -> { ex.Message}");
                MessageBox.Show($"Error in ShowDroponLayboyConveyor -> { ex.Message}");
            }
        }
