...
{
    public class TwoLineGraphicViewModel : TwoLineViewModelBase
    {
        protected readonly Prism.Events.IEventAggregator _eventAggregator;
             
        public TwoLineGraphicViewModel(IEventAggregator eventAggregator)
        {
        ...
        private async Task BaleTimerEventsAsync()
        {
            ...
            await Task.Run(() =>
            {
                ...
                if (BaleConveyorApproachLnOne > 0)
                {
                    ...
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearBalesOnScaleConveyorLineOne(); }));

                    //put Bale on scale conveyor in order from BaleOnApproachConveyor list
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.PutBaleOnScaleConveyorLineOne(BaleOnApproachConveyor); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearBalesOnScaleConveyorLineOne(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBalePressConveyorLineOne(); }));

                    //put Bale on Press conveyor
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.PutBaleOnPressConveyorLineOne(BaleOnWeighConveyor); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBalePressConveyorLineOne(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBaleMrkConveyorLineOne(); }));

                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.PutBaleOnMarkerConveyorLineOne(BaleOnPressConveyor); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBaleMrkConveyorLineOne(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBalesOnScaleConveyorLineTwo(); }));

                    //put Bale on scale conveyor in order from BaleOnApproachConveyor list
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.PutBaleOnScaleConveyorLineTwo(BaleOnApproachConveyorLn2); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBalesOnScaleConveyorLineTwo(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBalePressConveyorLineTwo(); }));

                    //put Bale on Press conveyor
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.PutBaleOnPressConveyorLineTwo(BaleOnWeighConveyorLn2); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBalePressConveyorLineTwo(); }));
                ...
                {
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBalesMrkConveyorLineTwo(); }));

                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.PutBaleOnMarkerConveyorLineTwo(BaleOnMarkerConveyorLineTwo); }));
                }
                else
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    { TwoLineGraphicView.BaleGraphicTwoLinesWindow.ClearAllBalesMrkConveyorLineTwo(); }));
        ...
        private void SetUpStationLineTwo()
        {
            ...
            StationTwoLineTwo = new BaleStationLineTwoViewModel(_eventAggregator, 0)
            {
                UnitColor = Brushes.White
            };
            StationTwoLineTwo.ShowStateionButton(false, "");

            StationThreeLineTwo = new BaleStationLineTwoViewModel(_eventAggregator, 1)
            {
                UnitColor = Brushes.White
            };
            ...
            StationFourLineTwo = new BaleStationLineTwoViewModel(_eventAggregator, 2)
            {
                UnitColor = Brushes.White
            };
            ...
            StationFiveLineTwo = new BaleStationLineTwoViewModel(_eventAggregator, 3);
