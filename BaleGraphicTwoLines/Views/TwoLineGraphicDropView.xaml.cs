...
using BaleGraphicTwoLines.ViewModels;
using Prism.Events;
using System.Collections.Generic;
using System.Windows;
using System.Windows.Controls;

namespace BaleGraphicTwoLines.Views
{
    /// <summary>
    /// Interaction logic for TwoLineGraphicDropView.xaml
    /// </summary>
    public partial class TwoLineGraphicDropView : UserControl
    {
        protected readonly Prism.Events.IEventAggregator _eventAggregator;
        public static TwoLineGraphicDropView BaleGraphicTwoLinesWindow;
        ...
        public TwoLineGraphicDropView(IEventAggregator eventAggregator)
        {
            InitializeComponent();
            BaleGraphicTwoLinesWindow = this;
            this._eventAggregator = eventAggregator;
            DataContext = new TwoLineGraphicDropViewModel(_eventAggregator);
        }
