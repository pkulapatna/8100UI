...
{
    /// <summary>
    /// Interaction logic for TwoLineGraphicView.xaml
    /// </summary>
    public partial class TwoLineGraphicView : UserControl
    {
        protected readonly Prism.Events.IEventAggregator _eventAggregator;
        public static TwoLineGraphicView BaleGraphicTwoLinesWindow;
        ...
        public TwoLineGraphicView(IEventAggregator eventAggregator)
        {
            InitializeComponent();
            this._eventAggregator = eventAggregator;
            BaleGraphicTwoLinesWindow = this;
            DataContext = new TwoLineGraphicViewModel(_eventAggregator);
